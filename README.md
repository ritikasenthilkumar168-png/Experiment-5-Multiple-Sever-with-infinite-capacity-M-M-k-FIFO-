...
```
# Collab Link:
https://colab.research.google.com/drive/1yu8bsnAHTWCAlEkeAGXOXlLAWJIukK1v?usp=sharing
...
Average number of objects in the system: 1.33
Average numner of objects in the conveyor: 0.53
Average waiting time of an object in the system: 13.32 secs
Average waiting time of an object in the conveyor: 13.32 secs
